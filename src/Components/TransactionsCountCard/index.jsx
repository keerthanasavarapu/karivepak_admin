      ...
      <Row>
          ...
          <Card>
            <CardBody style={{ padding: "20px" }}>
              <H6 attrH6={{ className: "fw-bolder" }}>
                <i className="icofont icofont-truck me-2"></i> Total Transactions
              </H6>
        ...
        <Col sm={12} xl={3} md={3}>
          <Card>
            <CardBody style={{ padding: "20px" }}>
              <H6 attrH6={{ className: "fw-bolder" }}>
                <i className="icofont icofont-user me-2"></i> Total Customers
              </H6>
              <H3 attrH3={{ className: "mb-0 mt-3 fw-bolder" }}>
        ...
        <Col sm={12} xl={3} md={3}>
          <Card>
            <CardBody style={{ padding: "20px" }}>
              <H6 attrH6={{ className: "fw-bolder" }}>
                <i className="icofont icofont-money me-2"></i> Total Revenue
              </H6>
              <H3 attrH3={{ className: "mb-0 mt-3 fw-bolder" }}>
        ...
        {/* <Col sm={12} xl={3} md={3}>
          <Card>
            <CardBody style={{ padding: "20px" }}>
              <H6 attrH6={{ className: "fw-bolder" }}>
                <i className="icofont icofont-chart-line me-2"></i> Net Profit
              </H6>
              <H3 attrH3={{ className: "mb-0 mt-3 fw-bolder" }}>
