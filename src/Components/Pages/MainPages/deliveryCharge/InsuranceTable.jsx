...
import TaxEditForm from "./TextEditForm";
...
const RazorpayTable = () => {
    ...
    const fetchGst = async () => {
        try {
            ...
            const response = await axios.get(`${baseURL}/api/deliverycharge/delivery-fee`, {
                headers: {
                    Authorization: `${token}`,
                }
            });
            ...
            const rate = response?.data?.distancePerKm
            setFormData({
                platformFee: Number(rate)
            })
    ...
    const handleUpdateGst = async () => {
        try {
            ...
            const response = await axios.put(`${baseURL}/api/deliverycharge/delivery-fee`, {
                distancePerKm: formData?.platformFee
            }, {
                headers: {
                    Authorization: `${token}`,
    ...
    return (
        <>
                            ...
                            <Modal show={show} onHide={handleClose} centered>
                                ...
                                <Modal.Footer>
                                    ...
                                    >
                                        ...
                                        <span className="ms-2" onClick={() => handleUpdateGst()}>Update Delivery charge</span>
                                    </Button>
                                </Modal.Footer>
                            </Modal>
            ...
            <div className="flex flex-col gap-3" >
                <span className="font-[500] text-lg">Delivery charge   -  ₹{formData.platformFee}</span>
