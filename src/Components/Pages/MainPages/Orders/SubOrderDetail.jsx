...
const SubOrderDetail = () => {
  ...
  console.log(subOrder, "suborder details")
          ...
          <Card>
            ...
            <CardBody>
              ...
              <div className="mt-4">
                ...
                <p className="text-muted">{subOrder?.deliveryDetails?.deliveryAddress?.full}</p>
              </div>
              ...
              {!subOrder?.deliveryDetails?.deliveryPersonId ? (
                <div className="mt-4">
                  <h5 className="mb-3">Delivery Person</h5>
                ...
                <div className="mt-4">
                  <h5 className="mb-3">Delivery Person</h5>
                  <p className="mb-1">{subOrder?.deliveryDetails?.deliveryPersonId?.name}</p>
                  <p className="text-muted">{subOrder?.deliveryDetails?.deliveryPersonId?.mobile}</p>
                </div>
              )}
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <div className="mb-4">
                ...
                <p className="mb-0">{subOrder?.deliveryDetails?.pickupAddress?.address}</p>
              </div>
            </CardBody>
          </Card>
        </Col>
